              ...
              <div className="col-md-4 my-auto">
                ...
                <ul className="contact-list">
                  <li>
                    <small id="contacts" className="lead text-white ">
                      <span>
                        <EnvelopeFill className="col-1 mx-3 my-3" />
                      </span>{" "}
                      meals@wheels.com
                    </small>
                  </li>
                  <li>
                    <small id="contacts1" className="lead text-white ">
                      <span>
                        <TelephoneFill className="col-1 mx-3 my-3" />
                      </span>
                      +62 812 8430 0979
                    </small>
                  </li>
                  <li>
                    <a
                      ...
                      href="https://www.instagram.com/lord_difit/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <span>
                        <Linkedin className="col-1 mx-3 my-3" />
                      </span>
                      Meals on Wheels
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <span>
                        <Instagram className="col-1 mx-3 my-3" />
                      </span>
                      @mealsonwheels
                    </a>
                  </li>
                  <li>
                    <a
                      id="contacts4"
                      className="lead text-white"
                      href="https://www.youtube.com/@xernomgaming3818"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <span>
                        <Youtube className="col-1 mx-3 my-3" />
                      </span>
              ...
              <div className="col-md-8">
                <div className="map-responsive">
                  <div style={{ borderRadius: "10px" }}>
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.5166128085034!2d107.59893341744385!3d-6.948221999999992!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e6279d52ed8b%3A0xfbc31838ba12ddbf!2sSekolah%20Tinggi%20Teknologi%20Bandung!5e0!3m2!1sid!2sid!4v1688222866125!5m2!1sid!2sid"
                      width="100%"
                      height="450"
                      style={{ border: "0" }}
                      allowFullScreen=""
